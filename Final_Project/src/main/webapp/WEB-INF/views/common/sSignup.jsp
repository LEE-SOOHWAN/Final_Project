 							...
 							<form class="user" action="signchk" id="form" method="post">
								<div class="form-group">
									<input type="hidden" class="form-control form-control-user"
											name="status" id="exampleStatus" value="학생">
								</div>
								<div class="form-group">
								...
								<div class="form-group row">
									...
									<div class="col-sm-6 mb-3 mb-sm-0">
										<input type="text" class="form-control form-control-user"
											name="age" id="exampleAge" placeholder="나이">
									</div>
									<div class="col-sm-6 mb-3 mb-sm-0">
										<input type="text" class="form-control form-control-user"
											name="school" id="exampleSchool" placeholder="학교">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<input type="text" class="form-control form-control-user"
											name="stuNum" id="exampleStuNum" placeholder="전화번호">
									</div>
									<div class="col-sm-6 mb-3 mb-sm-0">
										<input type="text" class="form-control form-control-user"
											name="parNum" id="exampleParNum" placeholder="부모님 전화번호">
									</div>
								</div>
								<div class="form-group">
									<input type="text" class="form-control form-control-user"
											name="fam" id="exampleFam" placeholder="가족 구성">
								</div>
								<div class="form-group">
									<input type="text" class="form-control form-control-user"
